          ...
          <ul>
            <li>
              <a
                ...
                href='https://github.com/JojokCreator'>
                {' '}
                Joe Klakus{' '}
              </a>
            </li>
            <li>
              <a className='hover:opacity-60' href='https://github.com/afam-io'>
                {' '}
                Afam Okoh{' '}
              </a>
            </li>
            ...
            <li>
              <a
                className='hover:opacity-60'
                href='https://github.com/danielknight261'>
                {' '}
                Daniel Knight{' '}
              </a>
            </li>
            <li>
              <a className='hover:opacity-60' href='https://github.com/Musy88'>
                {' '}
                Mustafa Mohamad{' '}
              </a>
            </li>
        ...
        <div className='p-2 mt-2 max-w-2xl  bg-white rounded-lg border border-gray-200 shadow-md md:w-144'>
          ...
          <ul>
            ...
            <li>
              <a
                className='hover:opacity-60'
                href='https://www.linkedin.com/in/afam-okoh-64328876'>
                {' '}
                Afam Okoh{' '}
              </a>
            </li>
            ...
            <li>
              <a
                className='hover:opacity-60'
                href='https://www.linkedin.com/in/daniel-knight-0b408123b'>
                {' '}
                Daniel Knight{' '}
              </a>
            </li>
            <li>
              <a
                className='hover:opacity-60'
                href='https://www.linkedin.com/in/mustafa-mohamad88/'>
                {' '}
                Mustafa Mohamad{' '}
              </a>
            </li>
